...
if($frm->validate()) {
    ...
    $borrar = true;
	$do_act = DB_DataObject::factory('solicituddematriz');
	$do_act->id_solicitud = $codigo;
...
$tpl->assign('secTitulo', "Borrar Solicitud de Matriz de Cliente");
