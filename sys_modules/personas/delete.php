...
if($frm->validate()) {
    ...
    $borrar = true;
	$do_act = DB_DataObject::factory('persona');
	$do_act->id_persona = $codigo;
    ...
    if ($borrar) {
		...
		if ($id) {
			...
			$do->query('ROLLBACK;');
			$error = 'Error en la eliminaci&oacute;n: '
                    . 'No puede borrar personas si tiene clientes relacionados. '
                    . 'Debe eliminar el cliente primero.</b></div>';
		}
	}
...
$tpl->assign('secTitulo', "Borrar Persona");
