...
class grillaHTML extends Structures_DataGrid
{
   ...
   // private $renderer;
    ...
    function grillaHTML($limit = null, $width='75%', $page = null,$ampliar=false)
    {
        ...
        $this->setRendererOption('sortIconDESC',"<img src=\"../".DIR_IMG."/down.gif\" border=\"0\" align=\"middle\">");
    }
    ...
    function getOutput($regs = 1) {
        if (($this->_ampliar) and (get_class($this->renderer) == 'Structures_DataGrid_Renderer_HTMLTable')) {
            ...
            if ($total>0){
                            if($regs){
                                $grilla=$grilla.'
                                <div align="center"><a href="#" onClick="ampliarGrilla_'.$key.'()">[Ampliar p&aacute;gina]</a></div><br/><br/><div><b>Total de registros encontrados: </b>'.$total.'</div><div id="dialog'.$key.'" style="display:none; overflow:auto;"></div><br/><div align="center" style="width:675px; overflow:auto;"id="dg'.$key.'">'.
                                        parent::getOutput().'</div>';
                            }
                            else{
                                $grilla=$grilla.'
                                <div align="center"><a href="#" onClick="ampliarGrilla_'.$key.'()">[Ampliar p&aacute;gina]</a></div><br/><br/><div id="dialog'.$key.'" style="display:none; overflow:auto;"></div><br/><div align="center" style="width:675px; overflow:auto;"id="dg'.$key.'">'.
                                    parent::getOutput().'</div>';
