...
$do = DB_DataObject::factory('tipo_matriz');
$do->tipo_matriz_id = $codigo;
...
if($frm->validate()) {
    ...
    $borrar = true;
	$do_act = DB_DataObject::factory('tipo_matriz');
	$do_act->tipo_matriz_id = $codigo;
...
$tpl->assign('secTitulo', "Borrar Tipo de Matriz");
