...
if($frm->validate()) {
    ...
    $borrar = true;
    if ($post['nombre_de_usuario'] == 'admin') {
        $borrar = false;
        $error = 'admin';
    }
	$do_act = DB_DataObject::factory('usuario');
	$do_act->id_usuario = $codigo;
...
elseif($error == 'admin'){
  $body = '<div id="contenido"><p><b>No puede borrar al usuario ADMIN</b></p>
...
$tpl->assign('secTitulo', "Borrar Usuario");
